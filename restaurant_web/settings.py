...
MIDDLEWARE = [
    ...
    'accounts.middleware.RoleGuardMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'public.context_processors.cart_count',
                'orders.context_processors.notification_context',
            ],
        },
    },
]
...
LOGIN_REDIRECT_URL = 'accounts:users_list'
